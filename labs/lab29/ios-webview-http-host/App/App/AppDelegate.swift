...
private final class ProbeViewController: UIViewController, WKNavigationDelegate, WKScriptMessageHandler {
    ...
    override func viewDidLoad() {
        ...
        guard let resourceURL = Bundle.main.resourceURL else {
            resultWriter.write(fileName: "wkwebview-mock-pressure-probe.json", status: "error", detail: "missing bundle resource url")
            return
        }
        ...
        guard FileManager.default.fileExists(atPath: htmlURL.path) else {
            resultWriter.write(fileName: "wkwebview-mock-pressure-probe.json", status: "error", detail: "missing bundled probe assets")
            return
        }
    ...
    private func write(status: String, detail: String) {
        ...
        reported = true
        resultWriter.write(fileName: "wkwebview-mock-pressure-probe.json", status: status, detail: detail)
    }
}
